...
public class Robot {
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        leftFrontDrive  = setupDriveMotor("fl", DcMotor.Direction.REVERSE);
        rightFrontDrive = setupDriveMotor("fr", DcMotor.Direction.FORWARD);
        leftBackDrive  = setupDriveMotor( "bl", DcMotor.Direction.REVERSE);
        rightBackDrive = setupDriveMotor( "br",DcMotor.Direction.FORWARD);
